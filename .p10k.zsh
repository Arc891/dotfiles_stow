# Generated by Powerlevel10k configuration wizard on 2024-02-24 at 22:30 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, slanted heads, slanted tails, 2 lines, dotted,
# right frame, light-ornaments, sparse, many icons, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_BACKGROUND=5
